...
public enum NoteOnAssignment {
	...
	SIGNAL_BASE(104), //
	TOUCH_VOLUME(104), //
	SHIFT(70), OPTION(71), CONTROL(72), ALT(73), UNDO(81), SAVE(80), CANCEL(82), ENTER(83), MARKER(84), NUDGE(85),
	CYCLE(86), DROP(87), REPLACE(88), CLICK(89), SOLO(90), //
	...
	ZOOM(100), SCRUB(101), //
	BANK_LEFT(46), BANK_RIGHT(47), TRACK_LEFT(48), TRACK_RIGHT(49), GLOBAL_VIEW(51), //
	GV_MIDI(62), GV_INPUTS(63), GV_AUDIO(64), GV_INSTRUMENT(65), GV_AUX(66), GV_BUSSES(67), GV_OUTPUTS(68), GV_USER(69);
