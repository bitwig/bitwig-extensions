...
public class DeviceLayer extends DisplayLayer implements NameContainer {
   ...
   public DeviceLayer(final MaschineExtension driver, final String name) {
      ...
      for (int i = 0; i < 8; i++) {
         ...
         final HardwareButton touchButton = driver.getTouchButtons()[i];
         ...
         macroLayer.bindPressed(touchButton, () -> parameter.touch(true));
         macroLayer.bindReleased(touchButton, () -> parameter.touch(false));
      }
