...
public class ColorSelectionMode extends PadMode {
   ...
   private static final BitWigColor[] PALETTE = new BitWigColor[]{BitWigColor.RED, BitWigColor.ORANGE, BitWigColor.AMBER, BitWigColor.YELLOW, //
