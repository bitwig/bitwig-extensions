...
abstract public class EzCreatorKeyCommonDefinition extends ControllerExtensionDefinition
{
   public EzCreatorKeyCommonDefinition(UUID driverID, String modelName)
   {
      mDriverID = driverID;
