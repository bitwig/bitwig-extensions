...
import com.bitwig.extensions.controllers.novation.launchkey_mk3.layer.ControlLayer;
import com.bitwig.extensions.controllers.novation.launchkey_mk3.layer.ControlMode;
import com.bitwig.extensions.controllers.novation.launchkey_mk3.layer.DeviceSelectionLayer;
import com.bitwig.extensions.controllers.novation.launchkey_mk3.layer.DrumPadLayer;
import com.bitwig.extensions.controllers.novation.launchkey_mk3.layer.PadMode;
...
public class LaunchkeyMk3Extension extends ControllerExtension {
    ...
    public void init() {
        ...
        final ControlLayer faderLayer =
            new ControlLayer("FADER", this, hwControl.getSliders(), LaunchkeyConstants.BUTTON_CC_FADER,
                LaunchkeyConstants.FADER_PARAM_OFFSET, ControlMode.VOLUME);
        ...
        faderLayer.activate();
        knobLayer.activate();
        final LaunchkeyMk3ExtensionDefinition extensionDefinition =
            (LaunchkeyMk3ExtensionDefinition) getExtensionDefinition();
        ...
        if (isMiniVersion()) {
            ...
            host.showPopupNotification(
                String.format("Launchkey %d Mk3 Initialized", extensionDefinition.numberOfKeys()));
        }
