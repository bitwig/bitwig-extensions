...
public class LaunchpadX extends ControllerExtension {

    // SYSEX
    private final String DAW_MODE = "F0 00 20 29 02 0C 10 01 F7";
    private final String STANDALONE_MODE = "F0 00 20 29 02 0C 10 00 F7";

    private final String SESSION_LAYOUT = "F0 00 20 29 02 0C 00 00 00 00 F7";
    private final String SESSION_MODE_PREFIX = "f0002029020e00000000";

    private final String SESSION_MODE_LED = "F0 00 20 29 02 0C 14 14 01 F7";
    private final String MIXER_MODE_LED = "F0 00 20 29 02 0C 14 24 01 F7";

    private final String DRUM_MODE = "F0 00 20 29 02 0C 0F 01 F7";
    private final String NOTE_MODE = "F0 00 20 29 02 0C 0F 00 F7";

    private final String DAW_VOLUME_FADER = "F0 00 20 29 02 0C 01 00 00 00 00 00 00 01 00 01 00 02 00 02 00 03 00 03 00 04 00 04 00 05 00 05 00 06 00 06 00 07 00 07 00 F7";
    private final String DAW_PAN_FADER = "F0 00 20 29 02 0C 01 01 01 00 01 08 00 01 01 09 00 02 01 0A 00 03 01 0B 00 04 01 0C 00 05 01 0D 00 06 01 0E 00 07 01 0F 00 F7";
    private final String DAW_SEND_A_FADER = "F0 00 20 29 02 0C 01 02 00 00 00 10 00 01 00 11 00 02 00 12 00 03 00 13 00 04 00 14 00 05 00 15 00 06 00 16 00 07 00 17 00 F7";
    private final String DAW_SEND_B_FADER = "F0 00 20 29 02 0C 01 03 00 00 00 18 00 01 00 19 00 02 00 1A 00 03 00 1B 00 04 00 1C 00 05 00 1D 00 06 00 1E 00 07 00 1F 00 F7";
    ...
    private final String DAW_FADER_ON = "F0 00 20 29 02 0C 00 0D F7";
    private final String DAW_FADER_OFF = "F0 00 20 29 02 0C 00 00 F7";

    public LaunchpadX(ControllerExtensionDefinition definition, ControllerHost host) {
        ...
        if (mMixerLayer.isActive()) {
            for (int i = 0; i < 32; i++) {
                ...
                if (i < 16)
                    ...
                    RGBState r = new RGBState(track.sendBank().getItemAt(0).sendChannelColor().get());
    ...
    private void initButtonLayer(Layer l, int p, RGBState rOn, RGBState rOff) {
        for (int i = 0; i < 8; i++) {
            ...
            // for (int j = 0; j < 8; j++) {
            // int jx = j;
            // l.bindLightState(() -> RGBState.OFF, mPadLights[ix][jx]);
            // l.bindPressed(mButtons[ix][jx], () -> {});
            // }
