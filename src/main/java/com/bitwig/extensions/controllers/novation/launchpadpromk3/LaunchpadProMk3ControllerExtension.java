...
public class LaunchpadProMk3ControllerExtension extends ControllerExtension implements ModeHandler {
   ...
   public void init() {
      ...
      hwElements = diContext.create(HwElements.class);
   ...
   private void initViewControlListeners() {
      ...
      cursorTrack.canHoldNoteData().addValueObserver(canHoldNoteData -> sysExHandler.enableClipPrint(canHoldNoteData));
