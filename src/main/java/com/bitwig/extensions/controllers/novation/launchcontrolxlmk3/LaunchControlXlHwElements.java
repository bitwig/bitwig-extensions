...
public class LaunchControlXlHwElements {
    ...
    public List<LaunchButton> getButtons(final int row) {
        final ArrayList<LaunchButton> buttons = new ArrayList<>();
        buttons.addAll(Arrays.asList(rowButtons).subList(row * 8, 8 + row * 8));
        return buttons;
    }
    ...
    public LaunchButton getButtons(final CcConstValues constValue) {
