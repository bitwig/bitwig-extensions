...
public class MainScreenSection {
    ...
    void init() {
        ...
        sliderMode.addValueObserver(newValue -> {
            contextPage.setHeaderText(newValue == SliderEncoderControl.State.MIXER ? "Mixer" : "Device");
            contextPage.getContextParts()[1].setFrame(newValue == SliderEncoderControl.State.MIXER
                ? ContextPart.FrameType.FRAME_SMALL
    ...
    private void initNavigationScreen() {
        ...
        contextPage = new ContextPageConfiguration(
            "Navigation",//
        ...
        context2.bindLight(
            navigationLayer, () -> sliderControl.getCurrentState().get() == SliderEncoderControl.State.MIXER
                ? RgbLightState.WHITE
        ...
        context4.bindRepeatHold(
            navigationLayer, cursorTrack::selectNext, BUTTON_WAIT_UTIL_REPEAT, HOLD_REPEAT_FREQUENCY);
    ...
    public void setPadInfo(final BasicStringValue padLocationInfo) {
    ...
    public void notifyPadMode(final SysExHandler.PadMode padMode) {
