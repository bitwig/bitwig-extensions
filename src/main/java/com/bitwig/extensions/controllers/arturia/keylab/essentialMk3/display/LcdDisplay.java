...
public class LcdDisplay {
    ...
    public void sendPopup(final String top, final String bottom, final KeylabIcon icon) {
        final String popUpTextSysEx = String.format(
            "%s01 %s02 %s03 %02X 00 F7", getScreenSysexHead("17"), textToSysEx(top), textToSysEx(bottom),
            icon.getKey());
    ...
    public void setTopIconText(final String top, final String bottom, final KeylabIcon icon,
        final boolean isTransient) {
