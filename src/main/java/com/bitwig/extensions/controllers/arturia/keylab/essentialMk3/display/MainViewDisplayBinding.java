...
public class MainViewDisplayBinding extends Binding<StringValue[], ContextPageConfiguration> {
    ...
    public MainViewDisplayBinding(final ContextPageConfiguration target, final LcdDisplay display,
    ...
    private void handleValueChanged1(final String value) {
        if (!isActive()) {
            return;
        }
    ...
    private void handleValueChanged2(final String value) {
        if (!isActive()) {
            return;
        }
