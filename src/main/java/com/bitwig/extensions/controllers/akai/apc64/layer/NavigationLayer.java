...
public class NavigationLayer {
    ...
    public NavigationLayer(final Layers layers, final HardwareElements hwElement, final ViewControl viewControl,
                           final ModifierStates modifierStates, final ApcPreferences preferences,
                           final Apc64MidiProcessor midiProcessor) {
        ...
        this.panelLayout.addValueObserver((oldValue, newValue) -> {
    ...
    private void initSessionNavigation(final Layer layer, final HardwareElements hwElements,
                                       final Apc64CcAssignments downButton, final Apc64CcAssignments upButton,
                                       final Apc64CcAssignments leftButton, final Apc64CcAssignments rightButton) {
