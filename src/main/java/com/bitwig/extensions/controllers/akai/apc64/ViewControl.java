...
public class ViewControl {
    ...
    private final ApcOverviewGrid overviewGrid = new ApcOverviewGrid();
    ...
    public int getTrackColor(final int index) {
    ...
    public boolean canScrollVertical(final int delta) {
        final int newPos = overviewGrid.getScenePosition() + delta;
        return newPos >= 0 && newPos < overviewGrid.getNumberOfScenes();
    }
    
    
    public boolean canScrollHorizontal(final int delta) {
        final int newPos = overviewGrid.getTrackPosition() + delta;
    ...
    public ApcOverviewGrid getOverviewGrid() {
        return overviewGrid;
    }
