...
public class APC40MKIIControllerExtension extends ControllerExtension
{
   ...
   private void setPhysicalPositions()
   {
      ...
      surface.hardwareElementWithId("TopKnob-1").setBounds(43.25, 12.5, 20.25, 20.0);
      ...
      surface.hardwareElementWithId("DeviceControl-0").setBounds(289.25, 90.25, 27.5, 24.25);
      surface.hardwareElementWithId("DeviceControl-1").setBounds(320.5, 90.75, 27.5, 24.25);
      surface.hardwareElementWithId("DeviceControl-2").setBounds(352.75, 90.75, 27.5, 24.25);
      ...
      surface.hardwareElementWithId("DeviceControl-5").setBounds(321.75, 122.25, 27.5, 24.25);
      surface.hardwareElementWithId("DeviceControl-6").setBounds(353.0, 122.5, 27.5, 24.25);
      surface.hardwareElementWithId("DeviceControl-7").setBounds(385.0, 122.5, 27.5, 24.25);
      surface.hardwareElementWithId("PrevDevice").setBounds(296.25, 155.25, 13.0, 6.25);
      surface.hardwareElementWithId("NextDevice").setBounds(327.75, 155.25, 13.0, 6.25);
      surface.hardwareElementWithId("PrevBank").setBounds(359.75, 155.5, 13.0, 6.25);
      surface.hardwareElementWithId("NextBank").setBounds(391.0, 155.0, 13.0, 6.25);
      surface.hardwareElementWithId("DeviceOnOff").setBounds(296.0, 173.25, 13.0, 6.25);
      surface.hardwareElementWithId("DeviceLock").setBounds(328.25, 173.0, 13.0, 6.25);
      surface.hardwareElementWithId("ClipDeviceView").setBounds(360.0, 173.0, 13.0, 6.25);
      surface.hardwareElementWithId("DetailView").setBounds(391.75, 173.25, 13.0, 6.25);
      surface.hardwareElementWithId("Shift").setBounds(359.75, 191.25, 13.0, 6.25);
      surface.hardwareElementWithId("Bank").setBounds(391.25, 191.0, 13.0, 6.25);
      ...
      surface.hardwareElementWithId("TrackVolumeFader-0").setBounds(9.75, 182.75, 21.75, 64.0);
      surface.hardwareElementWithId("TrackVolumeFader-1").setBounds(42.0, 183.0, 21.75, 64.0);
      surface.hardwareElementWithId("TrackVolumeFader-2").setBounds(73.75, 182.75, 21.75, 64.0);
      surface.hardwareElementWithId("TrackVolumeFader-3").setBounds(106.0, 183.0, 21.75, 64.0);
      surface.hardwareElementWithId("TrackVolumeFader-4").setBounds(138.0, 182.5, 21.75, 64.0);
      surface.hardwareElementWithId("TrackVolumeFader-5").setBounds(170.0, 182.75, 21.75, 64.0);
      surface.hardwareElementWithId("TrackVolumeFader-6").setBounds(201.75, 182.0, 21.75, 64.0);
      surface.hardwareElementWithId("TrackVolumeFader-7").setBounds(233.75, 183.0, 21.75, 64.0);
      surface.hardwareElementWithId("MasterTrackVolumeFader").setBounds(261.0, 183.0, 21.75, 64.0);
      ...
      surface.hardwareElementWithId("Grid-0-0").setBounds(7.0, 42.25, 28.0, 10.0);
      surface.hardwareElementWithId("Grid-0-1").setBounds(6.75, 57.25, 28.0, 10.0);
      surface.hardwareElementWithId("Grid-0-2").setBounds(7.25, 72.75, 28.0, 10.0);
      surface.hardwareElementWithId("Grid-0-3").setBounds(7.25, 88.0, 28.0, 10.0);
      surface.hardwareElementWithId("Grid-0-4").setBounds(6.75, 103.5, 28.0, 10.0);
      surface.hardwareElementWithId("Grid-1-0").setBounds(39.5, 42.0, 28.0, 10.0);
      surface.hardwareElementWithId("Grid-1-1").setBounds(38.5, 57.25, 28.0, 10.0);
      surface.hardwareElementWithId("Grid-1-2").setBounds(38.5, 72.0, 28.0, 10.0);
      surface.hardwareElementWithId("Grid-1-3").setBounds(39.0, 87.5, 28.0, 10.0);
      surface.hardwareElementWithId("Grid-1-4").setBounds(38.25, 103.25, 28.0, 10.0);
      surface.hardwareElementWithId("Grid-2-0").setBounds(70.75, 41.75, 28.0, 10.0);
      surface.hardwareElementWithId("Grid-2-1").setBounds(70.5, 57.25, 28.0, 10.0);
      surface.hardwareElementWithId("Grid-2-2").setBounds(70.75, 72.25, 28.0, 10.0);
      surface.hardwareElementWithId("Grid-2-3").setBounds(70.5, 87.75, 28.0, 10.0);
      surface.hardwareElementWithId("Grid-2-4").setBounds(70.5, 103.25, 28.0, 10.0);
      surface.hardwareElementWithId("Grid-3-0").setBounds(102.5, 41.75, 28.0, 10.0);
      surface.hardwareElementWithId("Grid-3-1").setBounds(102.75, 57.25, 28.0, 10.0);
      surface.hardwareElementWithId("Grid-3-2").setBounds(102.75, 72.25, 28.0, 10.0);
      surface.hardwareElementWithId("Grid-3-3").setBounds(102.5, 87.75, 28.75, 10.0);
      surface.hardwareElementWithId("Grid-3-4").setBounds(103.5, 103.0, 28.0, 10.0);
      surface.hardwareElementWithId("Grid-4-0").setBounds(135.0, 41.75, 28.0, 10.0);
      surface.hardwareElementWithId("Grid-4-1").setBounds(134.5, 57.25, 28.0, 10.0);
      surface.hardwareElementWithId("Grid-4-2").setBounds(134.75, 72.5, 28.0, 10.0);
      surface.hardwareElementWithId("Grid-4-3").setBounds(135.0, 87.75, 28.0, 10.0);
      surface.hardwareElementWithId("Grid-4-4").setBounds(135.25, 103.25, 28.0, 10.0);
      surface.hardwareElementWithId("Grid-5-0").setBounds(166.75, 41.75, 28.0, 10.0);
      surface.hardwareElementWithId("Grid-5-1").setBounds(167.0, 57.25, 28.0, 10.0);
      surface.hardwareElementWithId("Grid-5-2").setBounds(166.5, 72.0, 28.0, 10.0);
      surface.hardwareElementWithId("Grid-5-3").setBounds(166.75, 87.75, 28.0, 10.0);
      surface.hardwareElementWithId("Grid-5-4").setBounds(167.0, 103.25, 28.0, 10.0);
      surface.hardwareElementWithId("Grid-6-0").setBounds(198.5, 42.0, 28.0, 10.0);
      surface.hardwareElementWithId("Grid-6-1").setBounds(199.25, 57.25, 28.0, 10.0);
      surface.hardwareElementWithId("Grid-6-2").setBounds(198.75, 72.5, 28.0, 10.0);
      surface.hardwareElementWithId("Grid-6-3").setBounds(198.75, 87.75, 28.0, 10.0);
      ...
      surface.hardwareElementWithId("Grid-7-1").setBounds(230.75, 57.0, 28.0, 10.0);
      surface.hardwareElementWithId("Grid-7-2").setBounds(230.75, 72.75, 28.0, 10.0);
      surface.hardwareElementWithId("Grid-7-3").setBounds(230.75, 88.25, 28.0, 10.0);
      surface.hardwareElementWithId("Grid-7-4").setBounds(230.75, 103.25, 28.0, 10.0);
      surface.hardwareElementWithId("Scene-0").setBounds(263.25, 41.75, 17.25, 11.0);
      surface.hardwareElementWithId("Scene-1").setBounds(262.5, 56.5, 17.25, 11.0);
      surface.hardwareElementWithId("Scene-2").setBounds(262.75, 72.0, 17.25, 11.0);
      surface.hardwareElementWithId("Scene-3").setBounds(263.0, 87.0, 17.25, 11.0);
      surface.hardwareElementWithId("Scene-4").setBounds(262.75, 102.75, 17.25, 11.0);
      surface.hardwareElementWithId("Mute-0").setBounds(7.0, 152.75, 10.0, 10.0);
      surface.hardwareElementWithId("Mute-1").setBounds(39.5, 152.5, 10.0, 10.0);
      surface.hardwareElementWithId("Mute-2").setBounds(70.75, 153.25, 10.0, 10.0);
      surface.hardwareElementWithId("Mute-3").setBounds(102.75, 153.0, 10.0, 10.0);
      surface.hardwareElementWithId("Mute-4").setBounds(135.0, 152.75, 10.0, 10.0);
      surface.hardwareElementWithId("Mute-5").setBounds(167.5, 153.0, 10.0, 10.0);
      surface.hardwareElementWithId("Mute-6").setBounds(199.25, 153.0, 10.0, 10.0);
      surface.hardwareElementWithId("Mute-7").setBounds(231.5, 153.5, 10.0, 10.0);
      surface.hardwareElementWithId("Solo-0").setBounds(7.5, 167.0, 10.0, 10.0);
      surface.hardwareElementWithId("Solo-1").setBounds(39.25, 167.0, 10.0, 10.0);
      surface.hardwareElementWithId("Solo-2").setBounds(70.75, 167.25, 10.0, 10.0);
      surface.hardwareElementWithId("Solo-3").setBounds(103.0, 167.25, 10.0, 10.0);
      surface.hardwareElementWithId("Solo-4").setBounds(135.75, 167.25, 10.0, 10.0);
      surface.hardwareElementWithId("Solo-5").setBounds(167.5, 167.0, 10.0, 10.0);
      surface.hardwareElementWithId("Solo-6").setBounds(199.5, 167.5, 10.0, 10.0);
      surface.hardwareElementWithId("Solo-7").setBounds(231.75, 167.25, 10.0, 10.0);
      surface.hardwareElementWithId("Arm-0").setBounds(23.0, 166.75, 10.0, 10.0);
      surface.hardwareElementWithId("Arm-1").setBounds(55.5, 167.25, 10.0, 10.0);
      surface.hardwareElementWithId("Arm-2").setBounds(87.25, 167.25, 10.0, 10.0);
      surface.hardwareElementWithId("Arm-3").setBounds(118.75, 167.25, 10.0, 10.0);
      surface.hardwareElementWithId("Arm-4").setBounds(151.75, 167.5, 10.0, 10.0);
      surface.hardwareElementWithId("Arm-5").setBounds(183.0, 167.75, 10.0, 10.0);
      surface.hardwareElementWithId("Arm-6").setBounds(216.0, 167.5, 10.0, 10.0);
      surface.hardwareElementWithId("Arm-7").setBounds(248.0, 167.75, 10.0, 10.0);
      surface.hardwareElementWithId("AB-0").setBounds(23.5, 153.75, 10.0, 10.0);
      surface.hardwareElementWithId("AB-1").setBounds(55.75, 153.75, 10.0, 10.0);
      surface.hardwareElementWithId("AB-2").setBounds(87.25, 153.25, 10.0, 10.0);
      surface.hardwareElementWithId("AB-3").setBounds(119.5, 153.25, 10.0, 10.0);
      surface.hardwareElementWithId("AB-4").setBounds(151.5, 153.5, 10.0, 10.0);
      surface.hardwareElementWithId("AB-5").setBounds(182.5, 153.5, 10.0, 10.0);
      surface.hardwareElementWithId("AB-6").setBounds(216.0, 153.0, 10.0, 10.0);
      surface.hardwareElementWithId("AB-7").setBounds(247.5, 153.25, 10.0, 10.0);
      ...
      surface.hardwareElementWithId("MasterTrackSelect").setBounds(263.75, 137.75, 16.75, 9.25);
      ...
      surface.hardwareElementWithId("MasterTrackStop").setBounds(264.0, 120.25, 17.25, 11.0);
