...
public class X3MiniControllerExtensionDefinition extends ControllerExtensionDefinition
{
   @Override
      ...
      final AutoDetectionMidiPortNamesList list, final PlatformType platformType)
   {
      ...
      {
         case LINUX:
            list.add(new String[]{"X3mini MIDI 1"}, new String[]{"X3mini MIDI 1"});
            break;

         case WINDOWS:
            list.add(new String[]{"X3mini"}, new String[]{"X3mini"});
            break;
   ...
   public static X3MiniControllerExtensionDefinition getInstance()
   {
      return INSTANCE;
   }
   ...
   final private static X3MiniControllerExtensionDefinition INSTANCE = new X3MiniControllerExtensionDefinition();
   final private static UUID EXTENSION_UUID = UUID.fromString("bc74215a-f72a-4508-8297-6917fe59b176");
   final private static byte[] INIT_SYSEX = new byte[] {
      (byte) 0xF0, // Sysex Header
      0x00, 0x00, 0x74, // MIDI Plus bytes
      0x00, 0x01, // X2 product
