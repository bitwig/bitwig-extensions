...
public class Context {
    ...
    public Context(final ControllerExtension extension, final Package... packages) {
        this(extension, Set.of(), packages);
    }
    
    public Context(final ControllerExtension extension, final Set<String> tags, final Package... packages) {
        this.tags = tags;
    ...
    private boolean matchesTags(final ComponentClassBind component) {
        if (component.component().tag().isBlank()) {
            return true;
        }
        return tags.contains(component.component.tag());
    }
